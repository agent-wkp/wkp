...
- 2026-09-19: **D11's client side implemented** (issues #249/#251, PRs #250/#252):
  `.wkp/metrics.db`'s fixed-slot ring buffer, the `main.rs` dispatch
  instrumentation, and `wkp usage [--window 1h|1d|7d|30d] [--tool NAME]
  [--path DIR] [--json]` all shipped, on `main`. Documented in
  `docs/cli-reference.md`. The hub side (8.4, `wkp-hub usage`) remains
...
- 2026-09-18: **D11 added**: local usage metrics (per-tool invocation counts and
  ...
  5.5 and 8.4 below, and the updated 3.2/12 decision tables. **Client side
  implemented 2026-09-19, see the entry above; hub side still not built.**
